...
def load_config(auto_profile_idx=None):
    ...
    if not selected_section:
        print("\n=== Pilih Profil Kegiatan (KSA Jagung) ===")
...
def run_scrape(auto_profile_idx=None):
    ...
    print("=== KSA JAGUNG Scraping & Export Tool ===")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                page.goto("https://manajemen-ksapro.bps.go.id/evaluasi", wait_until="networkidle")
        ...
        try:
            ...
            file_name = f"ksa_jagung_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}_{download.suggested_filename}"
            ...
            page.screenshot(path="debug_ksa_jagung.png")
            print("[INFO] Screenshot disimpan ke 'debug_ksa_jagung.png'")
